...
#include <ti/drv/gpio/GPIO.h> //for GPIO 18.07.2019
#include <ti/drv/gpio/soc/GPIO_soc.h> //for GPIO 18.07.2019
//#include "GPIO_board.h" //for GPIO 18.07.2019
#include <ti/csl/soc.h> //for GPIO 18.07.2019

/* Test application stack size */
#define LPBK_APP_TSK_STACK_MAIN             (300U * 1024U)  // (60U*1024U)
//#define LPBK_APP_TSK_STACK_ETHERNET         (60U * 1024U)
#define LPBK_APP_TSK_STACK_ETHERNET         (60U * 1024U)
...
#define LPBK_APP_FRAMES_PER_CH          (1U)
...
#define LPBK_APP_DISP_MAX_FRM           (0U)
...
//BUF_WIDTH выравнивается на 16 байт (на 4 слова по 32 бита)
// эти параметры также используются для обрезки лишних данных в DMA
/* Buffer width in pixels to allocate. */
#define LPBK_APP_BUF_WIDTH              (1024)//(1920U) - 12.08.2019
//#define LPBK_APP_BUF_WIDTH              (1920)//(1920U) - 12.08.2019
/* Buffer height in lines to allocate. */
#define LPBK_APP_BUF_HEIGHT             (2)//(1080U) - 12.08.2019 (11) ;; 22.12.21 (4)
//#define LPBK_APP_BUF_HEIGHT             (11)//(1080U) - 12.08.2019 (11)

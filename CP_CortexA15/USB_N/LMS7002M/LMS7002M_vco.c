...
)
{
    ...
    *lo = csw_lowest;
    *hi = csw_highest;
    LMS7_logf(LMS7_DEBUG, "lowest CSW_VCO %i, highest CSW_VCO %i\n", csw_lowest, csw_highest);
    return 0;
}
...
)
{
    ...
    *vco_csw_reg = 0;
    ...
    {
        LMS7_logf(LMS7_DEBUG, "VCO select FAIL - too high \n");
        return -1;
    }
    ...
    *vco_csw_reg = 255;
    ...
    {
        LMS7_logf(LMS7_DEBUG, "VCO select FAIL - too low \n");
        return -1;
    }
    ...
    *vco_csw_reg = (csw_highest+csw_lowest)/2;
    LMS7002M_regs_spi_write(self, vco_csw_addr);
    LMS7_logf(LMS7_DEBUG, "lowest CSW_VCO %i, highest CSW_VCO %i, CSW_VCO %i \n", csw_lowest, csw_highest, *vco_csw_reg);

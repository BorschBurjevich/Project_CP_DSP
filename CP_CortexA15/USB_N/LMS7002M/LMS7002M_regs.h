...
#define REG_0X002B_MCLK1_DLY_3 3
#define REG_0X002B_MCLK2_DLY_3 3
...
struct LMS7002M_regs_struct
{
    ...
    int reg_0x0022_LML2_SISODDR;
    int reg_0x0022_LML1_TRXIQPULSE;
    int reg_0x0022_LML1_SISODDR;
    ...
    int reg_0x0025_lml1_BB2RF_PST;
    int reg_0x0025_lml1_BB2RF_PRE;
    int reg_0x0025_value;
    int reg_0x0026_lml1_RF2BB_PST;
    int reg_0x0026_lml1_RF2BB_PRE;
    ...
    int reg_0x0028_lml2_BB2RF_PST;
    int reg_0x0028_lml2_BB2RF_PRE;
    int reg_0x0028_value;
    int reg_0x0029_lml2_RF2BB_PST;
    int reg_0x0029_lml2_RF2BB_PRE;
...
static inline void LMS7002M_regs_init(LMS7002M_regs_t *regs)
{
    ...
    LMS7002M_regs_set(regs, 0x0084, 0x1400);
    ...
    LMS7002M_regs_set(regs, 0x010C, 0x88Fd); //0x88fd
    ...
    LMS7002M_regs_set(regs, 0x0640, 0xa0); //0XA0
...
static inline int LMS7002M_regs_default(const int addr)
{
    ...
    if (addr == 0x0640) return 0xa0; //0XA0
...
static inline void LMS7002M_regs_set(LMS7002M_regs_t *regs, const int addr, const int value)
{
   ...
   /* if (addr == 0x002A)
    ...
    if (addr == 0x002B)
    {
        ...
        regs->reg_0x002b_mclk2_inv = (value >> 9) & 0x1; // invers
        regs->reg_0x002b_mclk1_inv = (value >> 8) & 0x1;
        regs->reg_0x002b_mclk1_dly = (value >> 10) & 0x0;
        regs->reg_0x002b_mclk2_dly = (value >> 12) & 0x0;
        return;
    }
    if (addr == 0x002C)
    {
...
static inline int LMS7002M_regs_get(LMS7002M_regs_t *regs, const int addr)
{
    ...
    if (addr == 0x0022)
    {
        value |= (regs->reg_0x0022_LML2_TRXIQPULSE & 0x1) << 15;
        value |= (regs->reg_0x0022_LML2_SISODDR & 0x1) << 14;
        value |= (regs->reg_0x0022_LML1_TRXIQPULSE & 0x1) << 13;
        value |= (regs->reg_0x0022_LML1_SISODDR & 0x1) << 12;
    ...
    if (addr == 0x0025)
    {
        value |= (regs->reg_0x0025_lml1_BB2RF_PST & 0xf) << 8;
        value |= (regs->reg_0x0025_lml1_BB2RF_PRE & 0xf) << 0;
       // value |= (regs->reg_0x0025_value & 0xffff) << 0;
    }
    if (addr == 0x0026)
    {
        value |= (regs->reg_0x0026_lml1_RF2BB_PST & 0xf) << 8;
        value |= (regs->reg_0x0026_lml1_RF2BB_PRE & 0xf) << 0;
    ...
    if (addr == 0x0028)
    {
        value |= (regs->reg_0x0028_lml2_BB2RF_PST & 0xf) << 8;
        value |= (regs->reg_0x0028_lml2_BB2RF_PRE & 0xf) << 0;
       // value |= (regs->reg_0x0028_value & 0xffff) << 0;
    }
    if (addr == 0x0029)
    {
        value |= (regs->reg_0x0029_lml2_RF2BB_PST & 0xf) << 8;
        value |= (regs->reg_0x0029_lml2_RF2BB_PRE & 0xf) << 0;
    ...
    if (addr == 0x002B)
    {
        ...
        value |= (regs->reg_0x002b_mclk2_dly & 0x3) << 12;
        value |= (regs->reg_0x002b_mclk1_dly & 0x3) << 10;
        value |= (regs->reg_0x002b_mclk2_inv & 0x1) << 9;
        value |= (regs->reg_0x002b_mclk1_inv & 0x1) << 8;

...
#include <stdint.h>
#include <stdbool.h>
#include "USB_N/LMS7002M/LMS7002M_config.h"
#include "USB_N/LMS7002M/LMS7002M_regs.h"

#ifdef __cplusplus
extern "C" {
#endif
///////////////////////////////////////////////////
typedef uint32_t LMS7002mHandle; // Deskriptor
typedef uint32_t LMS7002m_STATUS;

#define LMS7002M_STATUS                     uint32_t
#define LMS7002M_PASS                       (0U)
#define LMS7002M_FAIL                       (-1U)
#define LMS7002M_TIMEOUT                    (-2U)
#define LMS7002M_INVALID_PARAM              (-3U)
///////////////////////////////////////////////////
//! direction constants
typedef enum
{
...
typedef struct
{
    uintptr_t hwHandle;                          /* hwHandle */
    uint32_t deviceId;                           /* deviceId */
    uint32_t busWidth;                           /* busWidth */
}LMS_Info;


typedef uint32_t (*LMS7002M_spi_transact_t)(void *handle, const uint32_t data,/* uint8_t *rxBuf,*/ const bool readback);
...
LMS7002mHandle LMS7002M_Open(uint32_t  deviceId,
                             uint32_t  portNum,
                             void     *params);
 ...
 */
LMS7002M_API LMS7002M_t *LMS7002M_create(uint32_t *handle);
 ...
 */
LMS7002M_API void LMS7002M_spi_write(LMS7002M_t *self, const int addr, const uint32_t value);

/////////////////////
LMS7002M_API void LMS7002M_usb_write(const int addr, const uint32_t value);
////////////////
 ...
 */
LMS7002M_API uint32_t LMS7002M_spi_read(LMS7002M_t *self, const int addr);
...
LMS7002M_API void LMS7002M_regs_usb_write(LMS7002M_t *self, const int addr,uint8_t *point_mas_tr);
 ...
 * \param addr the 16 bit register address
 */
LMS7002M_API uint32_t LMS7002M_regs_spi_read(LMS7002M_t *self, const int addr);
...
LMS7002M_API void LMS7002M_power_on(LMS7002M_t *self);
 ...
 */
LMS7002M_API void LMS7002M_configure_lml_port_TRXIQ(LMS7002M_t *self, const LMS7002M_port_t portNo, const LMS7002M_dir_t direction, const int mclkDiv);
...
LMS7002M_API void my_LMS7002M_configure_lml_port(LMS7002M_t *self, const LMS7002M_port_t portNo, const LMS7002M_dir_t direction, const int mclkDiv);
/*!
 ...
 * \param self an instance of the LMS7002M driver
 * \param direction the direction LMS_TX or LMS_RX
 * \param fref the reference clock frequency in Hz          fref - эталонная тактовая частота
 * \param fout the desired LO frequency in Hz               "желательная" LO частота - local oscillator - гетеродин генерирует сигнал на смещение от входящего
 * \param factual the actual LO frequency in Hz (or NULL)   "актуальная" LO частота
 * \return 0 for success or error code on failure
 */

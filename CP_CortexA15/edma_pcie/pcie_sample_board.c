...
void PlatformPCIESS1PllConfig(void)
{
    ...
    HW_WR_FIELD32(SOC_SEC_EFUSE_REGISTERS_BASE + CSL_CONTROL_CORE_SEC_SMA_SW_6,
                      CSL_CONTROL_CORE_SEC_SMA_SW_6_PCIE_TX_RX_CONTROL, 0x01U);
    ...
    HW_SET_FIELD(regVal, CM_CLKMODE_APLL_PCIE_REFSEL,
                 /*CM_CLKMODE_APLL_PCIE_REFSEL_CLKREF_ACSPCIE*/ CM_CLKMODE_APLL_PCIE_REFSEL_CLKREF_ADPLL);
    ...
    //HW_WR_REG32(0x4a00821c, 0x00000182);//APLL reference input clock is from ADPLL
    ////////////////////////////////////////////////////////////////////////////////
    /*Wait for APLL lock*/
